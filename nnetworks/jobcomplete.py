...
for i in tqdm(range(train.shape[0])):
    img = image.load_img('C:/Users/Vedant/Desktop/beproject/datasets/jobcomplete/'+str(train['id'][i])+'.jpg',target_size=(280,498,3))
...
model.fit(X_train, y_train, epochs=35, validation_data=(X_test, y_test), batch_size=6)
model.save('C:/Users/Vedant/Desktop/beproject/neumod/jobcomplete.h5')
del model
model = keras.models.load_model('C:/Users/Vedant/Desktop/beproject/neumod/jobcomplete.h5')

img = image.load_img('C:/Users/Vedant/Desktop/tpax/ks.jpg',target_size=(280,498,3))
img = image.img_to_array(img)
#img = img/255
