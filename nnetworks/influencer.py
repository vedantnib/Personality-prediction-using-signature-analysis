...
for i in tqdm(range(train.shape[0])):
    img = image.load_img('C:/Users/Vedant/Desktop/beproject/datasets/influencer/'+str(train['id'][i])+'.jpg',target_size=(280,498,3))
...
model = Sequential()
model.add(Conv2D(filters=2, kernel_size=(7, 7), activation="relu", input_shape=(280,498,3)))
...
model.fit(X_train, y_train, epochs=40, validation_data=(X_test, y_test), batch_size=5)
model.save('C:/Users/Vedant/Desktop/beproject/neumod/influencer.h5')
del model
model = keras.models.load_model('C:/Users/Vedant/Desktop/beproject/neumod/influencer.h5')

img = image.load_img('C:/Users/Vedant/Desktop/tpax/train_36.jpg',target_size=(280,498,3))
img = image.img_to_array(img)
#img = img/255
