...
for i in tqdm(range(train.shape[0])):
    img = image.load_img('C:/Users/Vedant/Desktop/beproject/datasets/warmfriend/'+str(train['id'][i])+'.jpg',target_size=(280,498,3))
...
model.save('C:/Users/Vedant/Desktop/beproject/neumod/warmfriend.h5')
del model
model = keras.models.load_model('C:/Users/Vedant/Desktop/beproject/neumod/warmfriend.h5')

img = image.load_img('C:/Users/Vedant/Desktop/tpax/ks1.jpg',target_size=(280,498,3))
img = image.img_to_array(img)
#img = img/255
